...
class SolidColors {
  ...
  static const Color statysNavColor = Color.fromARGB(255, 255, 255, 255);
  ...
  static const Color subPosterTitle = Color.fromARGB(200, 255, 255, 255);
...
class GradiantColors {
  ...
  static const List<Color> buttonNavBackgorund = [
